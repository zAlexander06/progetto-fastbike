            ...
            <div class="login-container">
                ...
                <div class="sezione-newUtente-recupero">
                    <div class="nuovo-utente">
                        <span>New User?</span>
                        <a href="registrazione.html">Create an account!</a>
                    </div>
                    <div class="recupero-utente">
                        <span>Have you lost your credentials?</span>
                        <a href="recuperoCredenziali.html">Recover here!</a>
                    </div>
                </div>
                <div class="tornaHomepage">
                    <button id="btn-torna-homepage">
                        <span id="img-home"></span>
                        <p style="margin-left: 10px;">Back to homepage</p>
                    </button>
